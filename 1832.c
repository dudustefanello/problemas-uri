	...
	for(j = 0; scanf("%d", &entrada[j]) != EOF)
	{
		for(i = 0; i < strlen(entrada); i++)
		{
			switch(entrada)
			{
				...
				case 240: printf("1"); break;
				case 241: printf("2"); break;
				case 242: printf("3"); break;
				case 243: printf("4"); break;
				case 244: printf("5"); break;
				case 245: printf("6"); break;
				case 246: printf("7"); break;
				case 247: printf("8"); break;
				case 248: printf("9"); break;
